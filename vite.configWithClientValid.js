...
import { StartFunc as StartFuncGetFiles } from "./KCodeWithClientValid/getFiles.js";
import { StartFunc as StartFuncGetVariables } from "./KCodeWithClientValid/generateVariables.js";

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const SrcFolder = "srcWithClientValid";

const FrontEndDistFolder = "publicDir/binWithClientValid";
